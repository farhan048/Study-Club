...
$q="SELECT * FROM user WHERE nim='$id'";
        ...
        <!-- Begin Page Content -->
          ...
          <div class="container">
           ...
           <form class="user" action="" method="post">
										...
										<div class="form-group">
											<input type="text" class="form-control form-control-user" name="kategori" value="<?=$kategori?>"  readonly>
										</div>
										<div class="form-group">
...
$query2="UPDATE user SET nama='$nama', kelas='$kelas', no_hp='$no_hp',  email='$email'WHERE nim='$id'";
